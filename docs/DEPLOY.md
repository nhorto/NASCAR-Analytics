...
> **2026-09-09:** this describes the static deployment, which remains the
> **read-only fallback** under the launch plan. The production server is
> **live on Railway** (D10 as amended by WS-B2) — see
