...
import { handleWebhookRequest, handleStripeWebhookRequest, handleRevenueCatWebhookRequest } from "./webhooks.ts";
...
export function createServer(
  ...
  const revenuecatWebhookDeps = {
    secret: cfg.revenuecatWebhookSecret,
    log: webhookDeps.log,
  };
