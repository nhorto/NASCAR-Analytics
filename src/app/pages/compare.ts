...
// pre-generating every driver pairing. Series and plan come from the
// `<html data-*>` attributes via boot.js (WS-I), not an inline script.
//
...
export function compareShell(pro = false): string {
